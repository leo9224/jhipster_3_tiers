...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).age(DEFAULT_AGE).ville(DEFAULT_VILLE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE).ville(UPDATED_VILLE);
        return contact;
    }
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE).ville(UPDATED_VILLE);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.nom(UPDATED_NOM).age(UPDATED_AGE).ville(UPDATED_VILLE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE).ville(UPDATED_VILLE);
